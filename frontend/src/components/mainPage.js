...
//   background:black;
  ...
  background: linear-gradient(90deg, rgb(30,148,165); 14%, hsla(178, 59%, 37%, 1) 62%);

background: -moz-linear-gradient(90deg, rgb(30,148,165); 14%, hsla(178, 59%, 37%, 1) 62%);

background: -webkit-linear-gradient(90deg, rgb(30,148,165); 14%, hsla(178, 59%, 37%, 1) 62%);
